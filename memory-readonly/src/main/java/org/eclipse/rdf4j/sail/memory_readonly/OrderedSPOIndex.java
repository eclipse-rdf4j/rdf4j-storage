...
class OrderedSPOIndex {
	...
	private Statement[] orderedArray;

	private Map<SpoCompound, ArrayIndex> spoIndex = new HashMap<>();
	private Map<SpCompound, ArrayIndex> spIndex = new HashMap<>();
	private Map<SCompound, ArrayIndex> sIndex = new HashMap<>();
