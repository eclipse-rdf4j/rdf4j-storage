 ...
 */
public class MemoryStoreReadonlyBplus extends AbstractNotifyingSail implements FederatedServiceResolverClient {

	private MemorySailStoreReadonly sailStore;

	public MemoryStoreReadonlyBplus(List<Statement> statements, List<Statement> statementsInferred) {
		sailStore = new MemorySailStoreReadonly(statements, statementsInferred);

	}

	public MemoryStoreReadonlyBplus(List<Statement> statements) {
	...
	protected NotifyingSailConnection getConnectionInternal() throws SailException {
		return new MemoryStoreReadOnlyBplusConnection(this, sailStore, getEvaluationStrategyFactory());
	}
